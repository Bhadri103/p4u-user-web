...
/**
 * Legacy /checkout is aligned to CartCheckout: buy-now clears then adds the
 * item, then the user is sent to /cart which supports address + COD + online pay.
 */
export default function CheckoutPage() {
  ...
  }, [router, searchParams, addToCart, clearCart]);
